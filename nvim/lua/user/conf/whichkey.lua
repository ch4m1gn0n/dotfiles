...
local mappings = {
	...
	-- w = {
	--   name = "Window",
	--   h = {"<cmd>split<cr>", "Split Winodw Horizontal"},
	--   v = {"<cmd>vsplit<cr>", "Split Winodw Vertical"},
	--
	-- },

  ["f"] = { "<cmd>lua require'telescope.builtin'.find_files(require('telescope.themes').get_dropdown({ previewer = false }))<cr>", "Find Files"},
  ["s"] = { "<cmd>lua require'telescope.builtin'.current_buffer_fuzzy_find(require('telescope.themes').get_ivy({layout_config={height=0.4}}))<cr>", "Search"},
...
function setKeybinds()
	...
	local opt = { prefix = "<localleader>", buffer = 0 }
